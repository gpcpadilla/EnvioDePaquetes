<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Index.Master" AutoEventWireup="true" CodeBehind="CreatePerson.aspx.cs" Inherits="ServicioEntregaPaquete.Web.CreatePerson" %>
                ...
                <div class="panel-body form-horizontal payment-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:ObjectDataSource ID="person" runat="server" SelectMethod="getPeople" TypeName="ServicioEntregaPaquete.Datos.PackageRepositorio">
            ...
            <div class="row">
                 ...
                 <div class="col-xs-12">
                    <div class="table-responsive">
                           <asp:GridView  CssClass="table preview-table" ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="Package">
                    <Columns>
                ...
                <asp:ObjectDataSource ID="Packages" runat="server" SelectMethod="getPackages" TypeName="ServicioEntregaPaquete.Datos.PackageRepositorio"></asp:ObjectDataSource>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="table-responsive">
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getPeople" TypeName="ServicioEntregaPaquete.Datos.PackageRepositorio"></asp:ObjectDataSource>
